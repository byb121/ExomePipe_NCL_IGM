...
print "# *Major change*:                                                                          #\n";
print "# 1. From this version annovar_2014jul14 is used, extra annotations added                  #\n";
print "# 2. popFreqMax is used as MAF filtering                                                   #\n";
...
print "# 5. Added function to use batch MAFs for filtering, when provided inHouseMAF will be      #\n";
print "#                                      ignored. Curent filtering thershold is set to 0.25  #\n";
print "# 6. Added function to output a new VCF file with extra annotations in INFO column.        #\n";
print "############################################################################################\n";
...
##reference=file:///sharedlustre/IGM/GATK/bundle2.8/b37/human_g1k_v37_decoy.fasta
...
##commandline="freebayes -v /home/a5907529/WORKING_DATA/Sophie_A2463/scripts/Freebayes/Free_out/Yaobo_Exome_17_Freebayes.vcf -f /sharedlustre/IGM/GATK/bundle2.8/b37/human_g1k_v37_decoy.fasta -L /home/a5907529/WORKING_DATA/Sophie_A2463/scripts/Freebayes/Bam.list --use-mapping-quality -C 5 --ploidy 2 -r 17 --min-alternate-count 5 --min-mapping-quality 30 --min-base-quality 30 --min-coverage 5 --genotype-qualities"
##fileDate=20141001
##phasing=none
