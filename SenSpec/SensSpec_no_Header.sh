...
REF_SNP="MauroAndI_latest_V/VariantList_hg19.txt" #Reference variants set
...
perl MauroAndI_latest_V/VariantQual_SenSpec_Multi_input.pl --sampleNames $SAMPLE_NAMES --refSNPs $REF_SNP --commonTail $COMMON_TAIL --samplePath $SAMPLE_PATH
